      ...
      <div className="bg-white-A700 flex flex-col font-dmsans items-center justify-start mx-auto w-full">
        <div className="flex flex-col items-center justify-start w-full">
          ...
          <div className="flex md:flex-col flex-row md:gap-5 items-center justify-evenly w-full">
            ...
            <div className="bg-white-A700 flex md:flex-1 flex-col gap-[26px] justify-start p-[7px] md:px-5 w-[46%] md:w-full">
              <div className="bg-blue_gray-50 flex md:flex-col flex-row gap-[25px] items-start justify-start ml-12 md:ml-[0] mr-[284px] p-2 rounded-[35px] w-[49%] md:w-full">
                <Button
                  className="bg-transparent cursor-pointer font-medium min-w-[148px] ml-3.5 md:ml-[0] text-base text-center text-gray-600_01"
                  size="lg"
              ...
              <div className="font-poppins md:h-[445px] h-[713px] sm:h-[841px] mb-[129px] md:ml-[0] ml-[66px] mr-[86px] relative w-[77%] sm:w-full">
                <div className="absolute flex flex-col md:gap-10 gap-[454px] h-full inset-y-[0] items-start justify-start my-auto sm:pr-5 pr-[34px] py-[34px] right-[0] w-[96%]">
                ...
                <div className="absolute flex flex-col inset-x-[0] items-start justify-start mx-auto top-[14%] w-[97%]">
